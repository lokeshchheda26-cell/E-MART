...
export function CartProvider({ children }) {
  ...
  // Whether the cart drawer is open. This lives here rather than in a page
  // component because the cart button now sits in the shared site header and
  // the drawer is mounted once at the app root - so ANY route can open it.
  // Previously both only existed inside the home page, which is why the cart
  // was unreachable from /orders, /profile, /about and so on.
  ...
  const value = {
    ...
    error: state.error,
    // Drawer UI state - see the note where it is declared above.
    isCartOpen,
    openCart,
    closeCart,
    refreshCart,
